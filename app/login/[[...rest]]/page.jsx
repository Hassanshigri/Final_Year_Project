    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="p-8">
          ...
          {/* Clerk SignIn Component (Email/Password) */}
          <SignIn
            routing="path"
            path="/login"
            signUpUrl="/signup"
            ...
            appearance={{
              elements: {
                ...
                footerActionLink: "text-blue-600 hover:text-blue-500 text-sm",
              },
            }}
            hideSignUp={true} // Remove sign up link since we have our own
          />
