									...
									>
										...
										<div className="grid grid-cols-1 gap-6">
											...
											<div className="flex flex-wrap justify-between gap-x-10 gap-y-4">
												...
												<Link
													href="/reset-password"
													className="text-base hover:text-[#4868a2]"
												>
													Forgot password?
												</Link>
											</div>
										...
										<button
											type="submit"
											className="button mt-7 block rounded-[50px] border-2 border-black bg-black py-4 text-white after:bg-[#4868a2] hover:border-[#4868a2] hover:text-white"
										>
											Sign in
										</button>
										{/* Form Group */}
